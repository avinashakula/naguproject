    ...
    initGraphConfig() {
        ...
        let data = {
            ...
            datasets: [{
                ...
                borderColor: "rgba(201,218,42)",
                borderWidth: 2,
                hoverBackgroundColor: "rgba(201,218,42)",
                hoverBorderColor: "rgba(201,218,42)",
            ...
            tooltips: {
                ...
                callbacks: {
                    labelColor: function (tooltipItem, chart) {
                        return {
                            borderColor: 'rgba(76,144,29, 1)',
                            backgroundColor: 'rgba(76,144,29, 1)',
                        }
                    },
                    ...
                    title: function (tooltipItem, chart) {
                        return tooltipItem[0].yLabel === 0 ? "E" : HelperFunctions.numberFormatter(tooltipItem[0].yLabel);
                    },
                },
                backgroundColor: 'rgba(76,144,29, 1)',
                titleMarginBottom: 0,
