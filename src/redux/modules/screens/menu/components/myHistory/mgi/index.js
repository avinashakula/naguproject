...
class MGHistory extends Component {
                                                                            ...
                                                                            <a className="list-bar"
                                                                               ...
                                                                               onClick={this.handleAccordian.bind(this, seasonIndex, monthIndex, null, monthData.month)}>
                                                                                ...
                                                                                <div className="col score-col"><span
                                                                                    className="history-score">{monthData.total_score === 0 ? "E" : HelperFunctions.addPlusSign(monthData.total_score)}</span>
                                                                                </div>
                                                                                <div className="col prize-col"><span className="history-score">{HelperFunctions.MGScoreFormat(monthData.max_score)}</span></div>
                                                                                                                    ...
                                                                                                                    >
                                                                                                                        <div className="block">
                                                                                                                            ...
                                                                                                                            <div
                                                                                                                                ...
                                                                                                                                <span>{HelperFunctions.MGScoreFormat(total_score)} </span>
                                                                                                                            </div>
